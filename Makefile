...
xpkg.build.provider-strapi: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Strapi CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Strapi controllers
